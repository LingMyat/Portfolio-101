    ...
    return (
        <div className="">
            ...
            <DragCloseDrawer open={open} setOpen={setOpen}>
                <div className="mx-auto grid grid-cols-2 gap-5 max-w-4xl h-full">
                    ...
                    <div className="space-y-4 pt-8">
                        ...
                        {url &&
                            (
                                ...
                                href={url}
                                target="_blank" 
                                class="relative inline-flex items-center justify-start w-[6rem] py-[0.4rem] overflow-hidden border border-white font-medium transition-all bg-neutral-900 rounded-sm hover:bg-neutral-900 group"
                                >
                                    <span 
            ...
            {open && (
                ...
                >
                    <motion.div
                        ...
                        className="absolute bottom-0 h-[50vh] w-full overflow-hidden rounded-t-3xl bg-neutral-900"
                        style={{ y }}
                        drag="y"
